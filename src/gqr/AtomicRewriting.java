...
//	}
    ...
    public AtomicRewriting cloneDummy() throws InconsistentAtomException {
        AtomicRewriting ret = new AtomicRewriting();
        List<SourceHead> sHeads = new ArrayList<SourceHead>();
        for (SourceHead sh : this.getSourceHeads())
    ...
    AtomicRewriting cloneDummyAndSetSourceHeadVars(List<Term> newsourceheadvars) throws InconsistentAtomException {
        AtomicRewriting ret = new AtomicRewriting();
        List<SourceHead> sHeads = new ArrayList<SourceHead>();
