...
//				System.out.println("********view "+viewNo+" *******");
				...
				long time;
				try {
					p = Runtime.getRuntime().exec("python "+System.getProperty("user.home")+"/users_link/gkonstant/Desktop/ssdsat/driver.py -t RW -v "+data.getAbsolutePath()+"/"+"view_ex -q "+data.getAbsolutePath()+"/"+"query_ex");
