...
public class AttrList
{
  ...
  public AttrList(String a_attrList)
  {
	  ...
	  while (st.hasMoreTokens()) {
		  ...
		  if(!isAdded)
			  throw new RuntimeException("No duplicate attribute names are allowed in a relation. Attr=" + name);
  ...
  public AttrList(ArrayList<String> attr)
  {
